...
FROM notafiscal n INNER JOIN cliente cl ON
	n.codcliente = cl.codcliente
WHERE n.codloja = '2'
					 
--2)
					 
SELECT l.nome
FROM notafiscal n INNER JOIN loja l ON
	n.codloja = l.codloja
WHERE n.data between '20/05/1999' and '30/05/1999'
GROUP BY l.nome,n.codloja
HAVING SUM(n.valortotal) >= ALL (
	SELECT SUM(n.valortotal)
	FROM notafiscal n
	WHERE n.data between '20/05/1999' and '30/05/1999'
	GROUP BY n.codloja
	)
...
SELECT l.nome, n.codcliente, SUM(n.valortotal)
FROM notafiscal n INNER JOIN loja l ON
	n.codloja = l.codloja
GROUP BY ROLLUP(n.codcliente,l.nome)
